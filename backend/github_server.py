    ...
    def __init__(self):
        ...
        if self.pat:
            try:
                ...
                print(f"GitHub MCP Server initialized for: {self.user.login}")
            except Exception:
    ...
    def execute_tool(self, tool_name: str, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            if tool_name == "github.list_repos":
                repos = [{"name": r.name, "url": r.html_url} for r in self.user.get_repos()[:5]]
                return {"repos": repos}
                ...
                return {"content": content.decoded_content.decode('utf-8')[:500]}
